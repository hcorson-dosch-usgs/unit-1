...
//// WEEK 3 CODE BELOW
// define the mydata variable globally
var mydata;

function debugCallback(response){
  // define mydata variable
  mydata = response;
  // data can be accessed within the callback function
  console.log('This is the data we requested: ', mydata);
  // append the response as plain text to the mydiv block in the body of our html
  $(mydiv).append('<br>GeoJSON data:<br>' + JSON.stringify(mydata));
};

function debugAjax(){
  // Use the basic jQuery ajax method to request the json data using an AJAX request
...
// data cannot be accessed outside of the callback function (prints undefined)
